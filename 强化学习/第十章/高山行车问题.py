...
#######################################################################
# Following are some utilities for tile coding from Rich. 瓦片编码部分
...
class IHT:
    ...
    def get_index(self, obj, read_only=False):
        ...
        if count >= size:
            ...
            """
            overfull_count 仅仅用于决定何时 print(表示已满的信息)
            """
...
def figure_10_1():
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig('figure_10_1.png')

if __name__ == '__main__':
    fig_name = 'figure_10_1'

    if fig_name == 'figure_10_1':
        figure_10_1()